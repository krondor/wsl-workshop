...
# define variables
args = {"evaluator_type": "binary", "threshold": {"min_value": 0.3, "metric": "areaUnderROC", "mid_value": 0.7}, "remoteHostImage": "", "execution_type": "DSX", "published": "false", "livyVersion": "livyspark2", "dataset": "/datasets/BreastCancerModelEval.csv", "remoteHost": ""}
model_path = os.path.join(os.getenv("DSX_PROJECT_DIR"), "models", os.getenv("DEF_DSX_MODEL_NAME", "Breast Cancer Automated GBT"), os.getenv("DEF_DSX_MODEL_VERSION", "1"), "model")
...
save_evaluation_metrics(eval_fields, "Breast Cancer Automated GBT", "1", startTime)