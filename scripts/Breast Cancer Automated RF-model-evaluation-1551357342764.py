...
model_path = os.path.join(os.getenv("DSX_PROJECT_DIR"), "models", os.getenv("DEF_DSX_MODEL_NAME", "Breast Cancer Automated RF"), os.getenv("DEF_DSX_MODEL_VERSION", "1"), "model")
...
save_evaluation_metrics(eval_fields, "Breast Cancer Automated RF", "1", startTime)